document.addEventListener("DOMContentLoaded", function() {
		...
		tocToggleMobile.addEventListener("click", function() {
			if (tocListMobile.style.display === "none" || tocListMobile.style.display === "") {
				tocListMobile.style.display = "block";
				tocToggleMobile.innerHTML = `<svg aria-hidden="true" class="e-font-icon-svg e-fas-chevron-up" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M207.029 130.524L12.686 324.868c-9.373 9.373-9.373 24.569 0 33.941l22.667 22.667c9.357 9.357 24.522 9.375 33.901.04L224 227.495l154.745 154.021c9.379 9.335 24.544 9.317 33.901-.04l22.667-22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 130.524c-9.373-9.372-24.569 9.372-33.942 0z"></path></svg>`;
			} else {
				tocListMobile.style.display = "none";
				tocToggleMobile.innerHTML = `<svg aria-hidden="true" class="e-font-icon-svg e-fas-chevron-down" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544 9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z"></path></svg>`;
			}
		});
		...
		window.addEventListener("scroll", function() {
			...
			// Mở dropdown của các thẻ có class link-item-custom active và chứa thẻ h3
